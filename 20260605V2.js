(() => {
  ...
  const isFr = document.documentElement.lang?.toLowerCase().startsWith("fr") || location.pathname.includes("/fr/");
  const labels = isFr
    ? { guided: "Accompagne", solo: "Seul", details: "Voir les details", max: "Max" }
    : { guided: "Begeleid", solo: "Alleen", details: "Details bekijken", max: "Max" };
